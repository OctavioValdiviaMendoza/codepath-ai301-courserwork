...
I have experience with JavaScript, React, Vite, HTML/CSS, Python, and backend application logic. I am especially interested in issues involving APIs, data handling, application state, authentication, debugging, testing, and server-side behavior. I am also open to frontend issues when they connect to broader application functionality, but I prefer backend-focused work. I would avoid issues requiring unfamiliar infrastructure without clear setup instructions.
